...
const PrivacyPolicyBanner: React.FC<Props> = ({ setShowPolicyBanner }) => (
  <div className={styles.container}>
    ...
    <p>
      ...
      Privacy Policy outlines the types of personal information that we receive
      and collect when you use our website, as well as how we use, protect, and
      disclose that information.
    </p>
    <h5>Information We Collect</h5>
    <p>
      When you visit our website, we may collect certain information
      automatically, including your IP address, browser type, operating system,
      referring URLs, and other usage information. We may also collect personal
      information that you voluntarily provide to us, such as your name, email
      address, and any other information you choose to provide through forms or
    ...
    <p>
      ...
      collect information about how you interact with our website. Please refer
      to our Cookie Policy for more information about the use of cookies on our
      website.
    </p>
    <h5>Third-Party Services</h5>
    <p>
      We may use third-party services, such as Google Analytics, to analyze
      website traffic and usage. These third-party service providers have their
      own privacy policies governing the collection, use, and disclosure of your
      information.
    </p>
    <h5>Data Security</h5>
    <p>
    ...
    <p>
      ...
      that we hold. If you have any questions or concerns about our use of your
